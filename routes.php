...
$routes = [
    ...
    $baseDir . '/Test' => 'app/apigateways/test.api.php',

    $baseDir . '/StayHappy' => 'app/views/StayHappy.php',

    $baseDir . '/EmailTest' => 'app/Emails/emailtest.php',
